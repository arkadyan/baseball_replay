defmodule BaseballReplayWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BaseballReplayWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BaseballReplayWeb.Gettext, "errors", msg, opts)
    end
  end
